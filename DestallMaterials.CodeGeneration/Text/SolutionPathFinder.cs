...
namespace DestallMaterials.CodeGeneration.Text
{
    class SolutionPathFinder
    {
        ...
        public static string FindSourceGenerationProject(string basePath)
        {
            var proj = SeekInParentDirectories(basePath, sourceGenerationProjectRegex, 5).FirstOrDefault();
            return proj;
        }
