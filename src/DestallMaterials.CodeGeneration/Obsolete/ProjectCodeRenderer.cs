...
public class ProjectCodeRenderer
{
    ...
    public ProjectCodeRenderer(string solutionDirectoryPath)
    {
        ...
        _fileWriter = new(_pathFinder, _logger);
    }
    ...
    public ProjectCodeRenderer Bind<TTemplate>(string projectName)
        where TTemplate : CodeGenerationEntryPoint
    {
    ...
    public ProjectCodeRenderer Bind(string projectName, Type templateType)
    {
        ...
        {
            throw new Exception($"Template component provided is not a {typeof(CodeGenerationEntryPoint).FullName}.");
        }
    ...
    async Task<Compilation> GetProjectCompilationAsync(string projectName)
    {
        ...
        var dependencyProjects = buildResult.First().ProjectReferences.SelectAsync(r => manager.GetProject(r));
    ...
    static bool IsComponent(Type type)
    {
        ...
        {
            if (type == typeof(CodeGenerationEntryPoint))
            {
                return true;
            }
            type = type.BaseType;
